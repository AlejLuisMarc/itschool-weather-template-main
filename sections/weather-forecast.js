...
function displayWeatherForecast(city) {
    // Primadata ne generam link-ul API-ului catre care vom face request-ul \\
    ...
    fetch(forecastWeatherEndpoint)
        ...
        .then((data) => {
            ...
            const {list} = data;
            // Ne declaram un obiect gol in care o sa ne tinem predictiile pe zile (Luni, Marti, Miercuri, etc.) \\
            const daysMap = {};
            ...
            list.forEach((element) => {
                ...
                // Altfel, daca nu avem ziua saptamanii in obiectul daysMap, o sa adaugam ziua respectiva impreuna cu elementul \\
                else {
                    daysMap[day] = [element];
                };
            });
